    ...
    <section id="skills" ref={ref} className="relative py-32 overflow-hidden">
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 gap-x-12 gap-y-8 md:grid-cols-2">
          {skills.map((s, i) => (
            <div key={s.name} data-reveal className="group">
              <div className="mb-3 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <span className="flex h-10 w-10 items-center justify-center rounded-lg border border-primary/30 bg-primary/10 text-primary transition-all group-hover:border-primary group-hover:shadow-[0_0_20px_hsl(var(--primary)/0.5)]">
